...
RUN curl -sSL https://github.com/docker/compose/releases/download/1.7.1/docker-compose-`/bin/uname -s`-`/bin/uname -m` > /usr/local/bin/docker-compose && /bin/chmod +x /usr/local/bin/docker-compose
